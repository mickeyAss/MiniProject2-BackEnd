...
import 'package:fontend_miniproject2/pages/follow_product_recriver.dart';
...
class DetailRecriverPafe extends StatefulWidget {
  String track = "";
  int uid = 0;
  int uid_recriver = 0;
  DetailRecriverPafe(
      ...
      required this.track,
      required this.uid,
      required this.uid_recriver});

  @override
  State<DetailRecriverPafe> createState() => _DetailRecriverPafeState();
}

class _DetailRecriverPafeState extends State<DetailRecriverPafe> {
                ...
                child: Center(
                  ...
                  child: ClipOval(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        onTap: () {
                          Get.to(() => FollowProductRecriverPage(
                              uid: widget.uid, track: widget.track, uid_recriver: widget.uid_recriver,));
                        },
                        child: Padding(
                          padding:
