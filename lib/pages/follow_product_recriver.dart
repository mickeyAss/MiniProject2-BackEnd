...
class FollowProductRecriverPage extends StatefulWidget {
  final String track;
  final int uid;
  final int uid_recriver;
  FollowProductRecriverPage(
      {super.key,
      required this.track,
      required this.uid,
  ...
  @override
  State<FollowProductRecriverPage> createState() =>
      _FollowProductRecriverPageState();
}

class _FollowProductRecriverPageState extends State<FollowProductRecriverPage> {
  ...
  void initState() {
    super.initState();
    loadDataProduct();
    log(widget.uid_recriver.toString());
  }
  ...
  Future<void> loadDataProduct() async {
    ...
    final response = await http
        .get(Uri.parse("$url/product/receiver/${widget.uid_recriver}"));
